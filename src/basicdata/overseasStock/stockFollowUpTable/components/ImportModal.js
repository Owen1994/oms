...
import { IMPORT_SKU } from '../constants/Apis';
            ...
            <div>
                <div>
                    <div className="tweb-choice-select tweb-list-filter-item" style={{ paddingLeft: '64px' }}>
                        1、准备数据 <a className="text-success" href={downloadUrl('/download/reportform/template-Inventory-follow-up-table.xlsx')}>下载导入模板</a>
                    </div>
