...
export default class Search extends React.Component {
    ...
    handleComparisonQuantity = (value) => {
        if (value === 4) {
            this.setState({
                hide: false,
            });
            ...
            <div className="search-bottom">
                ...
                <div className="inventory-search">
                    <FormItem
                        ...
                        label="库存搜索"
                    >
                        {getFieldDecorator('comparisonQuantity', {
                        })(
                            <CSelect
                                list={COMPARISON_QUANTITY}
                                placeholder="请选择"
                                code="code"
                                name="name"
                                apiListType={2}
                                handleChange={this.handleComparisonQuantity}
                            />,
                        )}
                    </FormItem>
                    {
                        this.state.hide ? (
                            <div className="inventory-search-input">
                                {getFieldDecorator('quantitysone', {
                                })(
                            ...
                            <div className="inventory-search-input">
                                <InputGroup compact>
                                    {getFieldDecorator('quantitysMin')(
                                        <InputNumber
                                            placeholder="请输入"
                                            maxLength="100"
                                        />,
                                    ...
                                    />
                                    {getFieldDecorator('quantitysMax')(
                                        <InputNumber
                                            placeholder="请输入"
                                            maxLength="100"
                                        />,
