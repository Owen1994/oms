...
(function ($)
{
    ...
    $.ligerDefaults.Filter.operators['string'] =
        $.ligerDefaults.Filter.operators['text'] =
            ["equal", "notequal", "startwith", "endwith", "like", "greater", "greaterorequal", "less", "lessorequal", "in", "notin", "enum"];
    ...
    $.ligerDefaults.Filter.editors['combobox'] =
        {
            create: function (container, field)
            {
                ...
                $.extend( options,field.field.editor.options || {});
    ...
    $.ligerui.controls.Filter.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _bulidGroupTableHtml: function (altering, allowDelete)
        {
            ...
            // tableHtmlArr.push('<option value="equal">' + p.strings['equal'] + '</option>');
