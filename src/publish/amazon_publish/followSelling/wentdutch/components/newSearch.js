...
class newSearch extends Component {
    ...
    render() {
        ...
        const selectSearch = (
            <div className="selectSearch amazon-followselling-wentdutch-search">
                <Row type="flex" align="middle">
                    ...
                    <Col {...this.span}>
                        <FormItem
                            ...
                            labelCol={this.labelCol}
                        >
                            {getFieldDecorator('belowPriceFlag', {
                                initialValue: -1
                            })(
                                <Select>
                                    {
                                        sellingPriceList.map(v => <Option value={v.value} key={v.value}>{v.name}</Option>)
                                    }
                                </Select>
                            )}
                        </FormItem>
                    ...
                    <Col {...this.span}>
                        ...
                        >
                            {getFieldDecorator('isDelete', {
                                ...
                                <Select>
                                    {
                                        isDeleteList.map(v => <Option value={v.value} key={v.value}>{v.name}</Option>)
                                    }
                                </Select>
                            )}
                        </FormItem>
