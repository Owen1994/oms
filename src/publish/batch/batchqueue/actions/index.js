...
const listUrl = "/listing/base/query/IListingStatusQueryService/query"
...
export const resetListParamsAction = text => ({ type: types.resetparams })
...
export const exportFileAction = (params)=>dispatch=>{
    return post('/listing/base/ext/IListingExtInfoService/createPlsEbayFileTask',{data:params})
    .then(data=>{
        if(data.state === "000001"){
            return data
        }
