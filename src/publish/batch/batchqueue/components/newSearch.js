...
import { Form, Radio, Input, Button, message, Select, Tooltip, DatePicker } from 'antd';
...
class Search extends Component {
    ...
    getParams = () => {
        ...
        if (!params.createTime || !params.createTime.length) {
            ...
            params.createTime = [
                params.createTime[0].valueOf(),
                params.createTime[1].valueOf()
            ]
        }
        return params
    }
                    ...
                    <FormItem>
                        {getFieldDecorator('searchType', {
                            ...
                            <RadioGroup size="small">
                                ...
                                <RadioButton value={3}>刊登人员</RadioButton>
                            </RadioGroup>
                        )}
                    </FormItem>
                </div>
