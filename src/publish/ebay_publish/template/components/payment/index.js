...
class App extends React.Component{
    ...
    handleSearch = (pageNumber, pageSize) => {
        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            if (!err) {
                ...
                this.props.getPaymentTemplate(params);
            }
        });
    }
    ...
    render(){
        ...
        return(
            <Functions { ...this.props } isPage={true} functionkey="008-000001-000002-016">
                  <div className="pbh-tle-list_container">
                    ...
                    <Table {...this.props}
                           ...
                           newToggleModal={(record, type) => {
                               this.setState({
                                item: record?record:undefined,
                                visible: true,
                                type
                           })}
                        }
