...
class table extends Component{
        ...
        },
        {
            ...
            render: (text, record) => (
                <div className="lgt-customs_set_btns">
                    <Functions { ...this.props } functionkey="008-000001-000002-015">
                          <span className="modify" onClick={() => this.props.newToggleModal(record.plsProfileId)}>编辑</span>
                    </Functions>
                    <Functions { ...this.props } functionkey="008-000001-000002-014">
    ...
    onConfirm = (record) => {
        ...
        fetchPost(DELETE_RETURN_TEMPLATE, {plsProfileIdArr:plsProfileIdArr}, 1)
            .then(result => {
    ...
    componentWillReceiveProps(nextProps) {
        const datas = nextProps.returnData;
        const prevDatas = this.props.returnData;
        if(datas !== prevDatas){
            this.setState({
                selectedRowKeys:[]
            })
    ...
    render(){
        ...
        const { data,total } = this.props.returnData;
            ...
            <div className="gallery-table breadcrumb margin-ms-top padding-sm">
                <div className="overflow-hidden">
                    <div className="pull-right">
                        <Functions {...this.props} functionkey="008-000001-000002-012">
                    ...
                    <div className="pull-left">
                        <Functions {...this.props} functionkey="008-000001-000002-013">
