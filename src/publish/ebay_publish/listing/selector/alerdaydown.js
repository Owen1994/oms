...
const getAlerdayDownData = state => state.tablemodel

export const parseAlerdayDownData = createSelector(
    [getAlerdayDownData],
    alerdayDownData => {
        alerdayDownData.lst = alerdayDownData.lst.map(item => {
