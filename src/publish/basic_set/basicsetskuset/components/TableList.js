...
export default class TableList extends React.Component {
        ...
        },
        {
            ...
            render: (text, record) =>
                    <div style={{ "textAlign": "center" }}>
                        <Functions {...this.props} functionkey={'008-000002-000002-003'}>
                            <a onClick={() => this.props.showAddUpdateModal(record)}
                                style={{ marginLeft: '10px' }}>
                                编辑
                            </a>
                        </Functions>
                        <Functions {...this.props} functionkey={'008-000002-000002-004'}>
    ...
    onConfirmDel = (record) => {
        fetchPost(DELETE_ITEM_API, {data:{modelName: 'skuPrefix', id: record.id}}, 1)
            .then(result => {
            ...
            <Spin spinning={loadingState} delay={500} tip="Loading...">
                <div>
                    <div className='margin-sm-top clear white padding-sm'>
                        <Functions {...this.props} functionkey={'008-000002-000002-002'}>
                            <Button className='pull-right' icon="plus" onClick={() => this.props.showAddUpdateModal()}>新增</Button>
                        </Functions>

                    </div>
                    <div className='publish-basic-set-sku white padding-notop-10'>
                        <Table
