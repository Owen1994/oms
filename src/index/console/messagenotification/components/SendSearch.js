                ...
                <Row type="flex" align="middle">
                    <Col span={8}>
                        <FormItem
                            label="角色类型:"
                        >
                            {getFieldDecorator('messageTypeSend', {
                                initialValue: -1,
                            })(
                                <CSelect
                                    placeholder="请选择"
                    ...
                    <Col span={8}>
                        <FormItem
                            label="状态:"
                        >
                            {getFieldDecorator('processStateSend', {
                                initialValue: -1,
                                rules: [
                    ...
                    <Col span={8}>
                        <FormItem
                            label="发送时间:"
                        >
                            {getFieldDecorator('sendTimesSend', {
        ...
        const typeSearch = (
            <div className="search_content">
                <FormItem
                    label="搜索类型"
                >
                    {getFieldDecorator('searchTypeSend', {
                        initialValue: 1,
                    })(
                ...
                <div className="content_right">
                    {getFieldDecorator('searchContentSend', {})(
                        <SearchInput
                            placeholder="请输入内容"
                            enterButton="搜索"
