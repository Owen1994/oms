...
// import { CONTRABAND_EDIT, 
//          CONTRABAND_DELETE } from "../constants";
...
class App extends Component {
    ...
    handleOk = ()=> {
        this.refs.form.validateFields((err, values) => {
            ...
            let data = disableinfoRef.getData();
            let params = {
                ...values,
                ...data
            }
            ...
            if (this.state.newVisible) {
                ...
                params.platformContrabandId = this.state.currentItem.platformContrabandId
                this.postEditRequest(params)
            }
        });
    }
    ...
    postEditRequest(params) {
        fetchPost(path.irp + 'PlatformContrabandAddPoolOrEdit/platformContrabandAddPoolOrEdit', params).then(data=>{
    ...
    showDeleteConfirm = (item) => {
        const params = { platformContrabandId: item.platformContrabandId }
        const self = this
        confirm({
            maskClosable: true,
            title: '确定要删除吗？',
            ...
            cancelText: '取消',
            onOk() {
                fetchPost(path.irp + 'PlatformContrabandPoolDelete/platformContrabandPoolDelete', params).then(data =>{
                    if(data && data.state === "000001"){
                        message.success('操作成功.');
                        self.listFetch();
                    } else {
    ...
    render() {
        ...
        return (
            <Functions { ...this.props } isPage={true} functionkey="007-000001-000006-001">
                <div className="contraband" >
                    <Search 
                        {...this.props} 
