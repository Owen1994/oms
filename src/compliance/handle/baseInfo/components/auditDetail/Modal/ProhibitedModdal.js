...
class App extends Component {
    ...
    columns = [
        {
            ...
            width: 20,
            render: (t, r) => {
                return <Checkbox checked={this.checkedIdList.includes(r.platformContrabandId)} onChange={(e) => this.checked(e, r)} />
            }
        }
    ]
    ...
    checked = (e, r) => {
        ...
        const index = this.checkedIdList.indexOf(r.platformContrabandId);
        if (value) {
            if (index !== -1) {
                this.checkedList.splice(index, 1, r)
                this.checkedIdList.splice(index, 1, r.platformContrabandId)
            } else {
                this.checkedList.push(r)
                this.checkedIdList.push(r.platformContrabandId)
            }
        } else {
            if (index === -1) return;
    ...
    listFetch = (pageNumber, pageData) => {
        ...
        fetchPost('/irp/api/GetPlatformContrabandPoolList/getPlatformContrabandPoolList', params)
            .then(data => {
        ...
        return (
            <div className="baseinfo-detail-modal">
                <div className="baseinfo-detail-modal-search">
                    <Input placeholder="请输入中文违禁品" onChange={this.setName} />
