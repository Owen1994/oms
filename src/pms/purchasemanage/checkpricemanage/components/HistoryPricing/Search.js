...
import { checkPriceTypeArr } from '../../constants/index';
...
class Search extends Component {
    ...
    getList = (data) => {
        const { getHistoryPricingListAsync, historyPricingList } = this.props;
        let params = historyPricingList.params;
        params = {
            ...params,
            ...data,
            pageNumber: 1,
    ...
    searchHandle = () => {
        ...
        validateFields((err, value) => {
            ...
            if (!value.inspector || !value.inspector.length) {
                value.inspector = '';
            }
            this.getList(value);
        });
    ...
    render() {
        ...
        const isShwoInspector = !hasPerssion('010-000003-000002-010', this.props);
        const isSupplier = !hasPerssion('010-000003-000002-013', this.props);
            ...
            <div className="audited-task-search-filters">
                ...
                >
                    {getFieldDecorator('checkPriceType', {
                        ...
                        <Select
                            onChange={value => this.getList({ checkPriceType: value })}
                            style={{ width: 344 }}
                        >
                            {
        ...
        const buttons = (
            <Row type="flex" align="middle" className="margin-ss-top">
                <Col className="text-right" span={2} />
                <Col>
                    <div style={{ width: 344, textAlign: 'right' }}>
                        <Button className="margin-sm-right" onClick={this.searchHandle} type="primary">搜索</Button>
        ...
        return (
            <div className="search bgcfff padding-sm-bottom padding-sm-top overflow-hidden audited-task-search">
