...
import {
    EXPORT_OUT_STOCK_DETAIL,
} from '../../constants/Api';
import Functions from '../../../../../components/functions';
import { GET_OUT_STOCK_DETAIL_LIST } from '../../constants';
...
export default class TableList extends React.Component {
    ...
    componentWillUnmount() {
        // 离开页面时清除列表数据
        this.props.clearRejectsList(GET_OUT_STOCK_DETAIL_LIST);
    }
    ...
    exportData = () => {
        ...
        fetchPost(EXPORT_OUT_STOCK_DETAIL, {
            data: {
                ...values,
        ...
        return (
            <div className="wms-tablelist breadcrumb">
                <div className="wms-addBtn">
                    <Functions {...this.props} functionkey="012-000010-000002-008">
                        <Button
                            icon="upload"
