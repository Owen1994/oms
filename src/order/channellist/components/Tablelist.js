...
import { tablemodelaction } from "../actions";
class Tablelist extends Component {
    ...
    columns = [{
        ...
        },
        {
            ...
            render: (text, record, index) => {
                const url = `/order/channellist/channelsignall/?orderId=${record.channelNumber}`;
                const menu = (
                    <Menu>
                        {functions(this, '001-000004-000002-004') ?
                        <Menu.Item>
                            <Link to={url+`&buttontype=2`} className={'viewbtn'} target="_blank">修改</Link>
                        </Menu.Item>
                            :null}
                        {functions(this, '001-000004-000002-005') ?
                        <Menu.Item>
                ...
                return (
                    <div className="actions-btns">
                        {functions(this, '001-000004-000002-002') ?
                        <Link to={url+`&buttontype=1`} className={'viewbtn'} target="_blank">查看</Link>:null}
    ...
    render() {
        ...
        const urlAdd = `/order/channellist/channelsignall/`;
        
        return (
                <div className="newCluenk">
                    <div className="title rightbtn">
                        {functions(this, '001-000004-000002-003') ?
                        <Link to={urlAdd} className="ant-btn ant-link">新 增</Link>:null}
                    </div>
