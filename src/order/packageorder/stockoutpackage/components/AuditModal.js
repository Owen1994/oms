...
export default class AuditModal extends React.Component {
    ...
    render() {
        const { visible, handleAudit, handleAuditLoading } = this.props;
                        ...
                        >
                            {
                                getFieldDecorator('auditStatus', {
                                    ...
                                    <RadioGroup onChange={handleAuditLoading}>
                                        {/* {
                        ...
                        >
                            {
                                getFieldDecorator('auditRemark')(
                                    <TextArea rows={4} onChange={handleAuditLoading} />
                                )
                            }
                        </FormItem>
                    </div>
