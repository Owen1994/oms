...
import { timestampFromat, functions } from 'util/baseTool.js';
import {
    DELETE_RULE,
} from '../constants/Api';
...
export default class Tablelist extends React.Component {
    columns = [
        ...
        },
        {
            ...
            render: (text, record, index) => {
                return (
                    <div>
                        {functions(this, '001-000004-000008-003') ?
                        ...
                        : null}
                        {functions(this, '001-000004-000008-004') ?
    ...
    render() {
        const { deliveryPriorityListData, pageNumber, pageData, onSearch, loadingState, toggleModal } = this.props;
        const total = deliveryPriorityListData.total;
        return (
            <div className="breadcrumb skureplacement-tablelist">
                <div className="skureplacement-optionBtn">
                    {functions(this, '001-000004-000008-002') ?
                ...
                <div>
                    <Spin spinning={loadingState}>
                        <Table
                            ...
                            dataSource={deliveryPriorityListData.data}
                            pagination={false}
