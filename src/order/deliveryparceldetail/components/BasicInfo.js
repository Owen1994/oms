            ...
            <div className="newCluenk cl-warehouse">
                ...
                <div className="content">
                    <Row>
                        <Col span={6}>
                            <FormItem
                                label="平台单号"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="YKS单号"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="包裹单号"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="订单来源"  {...this.formItemLayout3} className="widthAll">
                    ...
                    <Row>
                        <Col span={6}>
                            <FormItem
                                label="分配仓库"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="平台订单状态"  {...this.formItemLayout3} className="widthAll">
                    ...
                    <Row>
                        {/* <Col span={6}>
                            <FormItem
                                label="试算运费"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="销售账号"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="抓单时间"  {...this.formItemLayout3} className="widthAll"
                            >
                        ...
                        <Col span={6}>
                            <FormItem
                                label="付款时间"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="是/否负利润"  {...this.formItemLayout3} className="widthAll">
                    ...
                    <Row>
                        <Col span={6}>
                            <FormItem
                                label="分仓订单状态"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="客选物流"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                label="是/否偏远地区"  {...this.formItemLayout3} className="widthAll">
                    ...
                    {/* <Row className="margin-ms-top padding-sm-bottom">
                    </Row> */}
                </div>
            </div>
        );
