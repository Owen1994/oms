...
class Filteritem extends React.Component {
    ...
    render(){
        ...
        const ulClass = flex?"tweb-list-filter-item-ul one-line":"tweb-list-filter-item-ul"
        return (  
            <div className="tweb-list-filter-item">
                <div className="tweb-list-filter-item-title">{data.title}：</div>
                <ul className={ulClass}>
                    ...
                    }
                    {
                        ...
                        oneLine? 
                        <span onClick={this.flexHandle} className="tweb-list-filter-item-ul-flex-btn">
                        {
                            flex?
