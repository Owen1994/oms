...
const multipleURL = '/oms/order/manage/motan/service/api/IOrderManageService/getSellerIds';
const countryIdURL = '/oms/order/manage/motan/CommonBasicsDataApi/queryCountrlData';
const orderTypeIdURL = '/oms/order/manage/motan/ICompanyOrderManageApi/getType';
const customerServiceIdURL = '/oms/order/manage/motan/ICompanyOrderManageApi/getCustomer';
...
class Condition extends Component {
    ...
    handleSearch = () => {
        ...
        setTimeout(() => {
            // 请求订单状态数据
            const searchParams = this.props.filterSearchParams();
            this.props.getStatus(searchParams);
        }, 300);
    }
    ...
    render() {
        ...
        const { dicSaleAccount, orderState, paramePlatformId, handleChange, toggleModal, toggleModal2 } = this.props;
                ...
                <Row type="flex" align="middle">
                    ...
                    <Col  span={8}>
                        <InputGroup compact>
                            ...
                            <span className="orderlist-money-separate">~</span>
