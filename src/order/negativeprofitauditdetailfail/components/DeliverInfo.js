        ...
        return (
            <div className="newCluenk cl-warehouse">
                ...
                <div className="content">
                    <Row>
                        <Col span={6}>
                            <FormItem label="内单号"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="发货仓库"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="物流渠道"  {...this.formItemLayout3} className="widthAll">
                    ...
                    <Row>
                        <Col span={6}>
                            <FormItem label="渠道编码"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="跟踪号1"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="跟踪号2"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="重量"  {...this.formItemLayout3} className="widthAll">
                    ...
                    <Row>
                        <Col span={6}>
                            <FormItem label="运费"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="客服"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem label="发货时间"  {...this.formItemLayout3} className="widthAll">
                        ...
                        <Col span={6}>
                            <FormItem
                                ...
                                {getFieldDecorator('logisticsSurface')(
                                    <a className="text-success font-sm" href={this.props.Infos.logisticsSurface?this.props.Infos.logisticsSurface:'javascript:;'} target='_blank'>{this.props.Infos.logisticsSurface?'点击查看':''}</a>
                                )}
                            </FormItem>
                        </Col>
                    </Row>
